...
- [`homesrvctl/bootstrap.py`](homesrvctl/bootstrap.py)
  Fresh-host bootstrap assessment plus tunnel/runtime provisioning helpers.
...
- [`homesrvctl/commands/bootstrap_cmd.py`](homesrvctl/commands/bootstrap_cmd.py)
  Fresh-host bootstrap assessment plus tunnel/runtime provisioning command surface.
