...
- The daemon and local runtime observers refresh cached state; systemd support manages only the daemon process lifecycle. They must not mutate stacks, routing, provider state, or secrets.
